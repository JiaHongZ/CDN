...
save_path =  os.path.join('model_zoo',str(sigma)+'color')
if not os.path.exists(save_path):
    os.makedirs(save_path)
utils_logger.logger_info(logger_name, os.path.join('model_zoo',str(sigma)+'color', logger_name + '.log'))
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_set,
                              ...
                              drop_last=True,
                              pin_memory=True)
    test_set = DatasetDRNet(in_channels,patch_sizes[0],sigma,False,r'testsets\set5')
