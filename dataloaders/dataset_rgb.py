...
class DataLoaderTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_H = getattr(augment, apply_trans)(clean)
        img_L = getattr(augment, apply_trans)(noisy)
        img_Ls = [img_L[:, 0:int(self.patch_size // 2), 0:int(self.patch_size // 2)],
                  img_L[:, 0:int(self.patch_size // 2), int(self.patch_size // 2):self.patch_size],
                  img_L[:, int(self.patch_size // 2):self.patch_size, 0:int(self.patch_size // 2)],
                  img_L[:, int(self.patch_size // 2):self.patch_size, int(self.patch_size // 2):self.patch_size],
                  ]
        img_Hs = [img_H[:, 0:int(self.patch_size // 2), 0:int(self.patch_size // 2)],
                  img_H[:, 0:int(self.patch_size // 2), int(self.patch_size // 2):self.patch_size],
                  img_H[:, int(self.patch_size // 2):self.patch_size, 0:int(self.patch_size // 2)],
                  img_H[:, int(self.patch_size // 2):self.patch_size, int(self.patch_size // 2):self.patch_size],
                  ]
