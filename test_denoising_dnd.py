...
parser.add_argument('--input_dir', default='D:\zjh_home\MIRNet-master\datasets\dnd',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/denoising/dnd/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default=r'D:\zjh_home\CompDNet\model_zoo\realnoise\best.pth',
...
model_restoration = Net(3, 3, 64).cuda()
...
with torch.no_grad():
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        rgb_restored = model_restoration(rgb_noisy,False)
