...
if __name__ == '__main__':
    path = r'E:\image_denoising\datasets\DIV2K\DIV2K_train_HR\DIV2K_train_HR'
    outpath = r'E:\image_denoising\datasets\DIV2Kpatch2'
    ...
    for name in image_names:
        ...
        (winW, winH) = (int(512),int(512))
        stepSize = (int(256), int(256))
        cnt = 0
